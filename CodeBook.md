...
fBodyBodyGyroJerkMag-meanFreq()	The STD and MEAN values for each subject per activity take as the average. 79 in total.  For units see original documentation: The units used for the accelerations (total and body) are 'g's (gravity of earth -> 9.80665 m/seg2).
- The gyroscope units are rad/seg.
...
-	Replace ‘”’ with ‘’
-	Replace ‘ ‘ with ‘,’
A snapshot of the produced data is below:
